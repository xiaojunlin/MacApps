...
hyper.bindKey(';', function() am.switchToAndFromApp("com.apple.Safari") end)
hyper.bindKey('\'', function() am.switchToAndFromApp("org.rstudio.RStudio") end)
hyper.bindKey(',', function() am.switchToAndFromApp("com.apple.Notes") end)
hyper.bindKey('.', function() am.switchToAndFromApp("com.flexibits.fantastical2.mac") end)
...
hyper.bindKey('k', function() am.switchToAndFromApp("com.agilebits.onepassword7") end)
hyper.bindKey('s', function() am.switchToAndFromApp("com.nssurge.surge-mac") end)
